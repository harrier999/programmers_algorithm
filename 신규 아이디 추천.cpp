...
vector<char> string_to_vec(string str) {
...
vector<char> step1(vector<char> str) {
	vector<char> ret;
...
vector<char> step2(vector<char> str) {
	vector<char> ret;
	for (int i = 0; i < str.size(); i++) {
...
vector<char> step3plus_4(vector<char> str) {
	vector<char> ret;
	int count = 0;
	for (int i = 0; i < str.size(); i++) {
		if (str[i] == '.')
...
vector<char> step6(vector<char> str) {
	vector<char> ret;
	if (str.size() > 15) {
		for (int i = 0; i < 15; i++) {
			ret.push_back(str[i]);
